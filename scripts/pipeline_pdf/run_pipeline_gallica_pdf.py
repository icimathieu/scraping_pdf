...
def main() -> None:
    ...
    parser.add_argument("--pdf-rpm", type=float, default=0.2)
    ...
    parser.add_argument("--step2-cb-threshold", type=int, default=2)
    parser.add_argument("--step2-cb-sleep-seconds", type=int, default=3600)
